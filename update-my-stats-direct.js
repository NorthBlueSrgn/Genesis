// Simple script to update YOUR account stats in Firestore
...
async function updateMyStats() {
  const uid = '5CV9Q1rkUZTmqJsaMckBV3eI8H82'; // YOUR UID
  ...
  try {
    ...
    console.log('✅ SUCCESS! Your stats have been updated in Firestore.');
    console.log('\nUpdated stats:');
